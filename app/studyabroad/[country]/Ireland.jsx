...
const StudyInIreland = () => {
  return (
    <div className="max-w-4xl mx-auto px-3 py-8" style={{ fontFamily: 'Times New Roman, serif' }}>
      ...
      <h2 className="text-2xl font-bold mt-6 mb-4">Why Choose Ireland for Your Higher Studies?</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold mt-6 mb-4">Top Universities and Colleges in Ireland</h2>
      ...
      <h2 className="text-2xl font-bold mt-6 mb-4">Fees Structure for Studying in Ireland</h2>
      <ul className="list-disc ml-6 mb-4">
      ...
      <h2 className="text-2xl font-bold mt-6 mb-4">Cost of Living in Ireland</h2>
      <ul className="list-disc ml-6 mb-4">
      ...
      <h2 className="text-2xl font-bold mt-6 mb-4">Work Opportunities in Ireland for International Students</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold mt-6 mb-4">Post-Graduation Work Opportunities in Ireland</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold mt-6 mb-4">Why Choose <span className="text-orange-500">VJC Overseas</span> to Study in Ireland?</h2>
      <ul className="list-disc ml-6 mb-4">
      ...
      <h2 className="text-2xl font-bold mt-6 mb-4">Start Your Journey to Ireland Today</h2>
      <p className="mb-4">
