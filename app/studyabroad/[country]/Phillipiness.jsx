...
const StudyInPhilippines = () => {
  return (
    <div
      className="max-w-4xl mx-auto px-3 py-8 text-justify text-lg leading-relaxed"
      style={{ fontFamily: "Times New Roman, serif" }}
    >
      <h1 className="text-3xl font-bold mb-6">
        Study in the Philippines: Affordable Education & Unmatched Benefits |{" "}
      ...
      <h2 className="font-semibold text-2xl mt-6 mb-2">Why Study in the Philippines?</h2>
      <p>
      ...
      <h3 className="font-semibold text-xl mt-4 mb-1">1. Affordable Tuition Fees</h3>
      <p>
      ...
      <h3 className="font-semibold text-xl mt-4 mb-1">2. Living Costs in the Philippines</h3>
      <ul className="list-disc ml-6 space-y-2">
      ...
      <h2 className="font-semibold text-2xl mt-6 mb-2">Top Benefits of Studying in the Philippines</h2>

      <h3 className="font-semibold text-xl mt-4 mb-1">1. High-Quality Education</h3>
      <p>
      ...
      <h3 className="font-semibold text-xl mt-4 mb-1">2. English Language Proficiency</h3>
      <p>
      ...
      <h3 className="font-semibold text-xl mt-4 mb-1">3. World-Class Medical Education</h3>
      <p>
      ...
      <h3 className="font-semibold text-xl mt-4 mb-1">4. Cultural Diversity</h3>
      <p>
      ...
      <h3 className="font-semibold text-xl mt-4 mb-1">5. Vibrant Student Life</h3>
      <p>
      ...
      <h3 className="font-semibold text-xl mt-4 mb-1">6. Pathway to Global Careers</h3>
      <p>
