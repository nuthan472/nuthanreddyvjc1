...
const StudyInLuxembourg = () => {
  return (
    <div className="max-w-4xl mx-auto px-3 py-8" style={{ fontFamily: 'Times New Roman, serif' }}>
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Why Study in Luxembourg?</h2>
      <p className="mb-6">
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Top Colleges & Universities in Luxembourg</h2>
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">University Fees & Financial Aid</h2>
      <p className="mb-6">
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Cost of Living</h2>
      <ul className="list-disc ml-6 mb-6 space-y-2">
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Work Opportunities for International Students</h2>
      <p className="mb-6">
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Benefits of Studying in Luxembourg</h2>
      <ul className="list-disc ml-6 mb-6 space-y-2">
      ...
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">Conclusion: Make Luxembourg Your Study Destination</h2>
      <p>
