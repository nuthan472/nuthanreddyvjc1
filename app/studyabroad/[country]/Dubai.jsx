  ...
  return (
    <div className="max-w-4xl mx-auto px-3 py-8" style={{ fontFamily: 'Times New Roman, serif' }}>
      <h1 className="text-3xl font-bold mb-4">
        Study in Dubai with <span className="text-orange-500">VJC Overseas</span>: Your Gateway to a Bright Future
      </h1>
      ...
      <h2 className="text-2xl font-semibold mb-2">Why Study in Dubai?</h2>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Universities and Colleges in Dubai</h2>
      <ul className="list-disc ml-6 space-y-2">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">College and University Fees in Dubai</h2>
      <ul className="list-disc ml-6 space-y-2">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Living Costs in Dubai</h2>
      <ul className="list-disc ml-6 space-y-2">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Work Opportunities for International Students in Dubai</h2>
      <ul className="list-disc ml-6 space-y-2">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Benefits of Studying in Dubai</h2>
      <ul className="list-disc ml-6 space-y-2">
