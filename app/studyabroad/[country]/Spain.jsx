  ...
  return (
    <div className="max-w-4xl mx-auto px-3 py-8" style={{ fontFamily: 'Times New Roman, serif' }}>
      <h1 className="text-3xl font-bold mb-4 text-center">
        Study in Spain – <span className="text-orange-500">VJC Overseas</span>: Your Gateway to World-Class Education
      </h1>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Why Study in Spain? Top Benefits of Studying Abroad in Spain</h2>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Understanding the Fees in Spanish Universities</h2>
      <ul className="list-disc ml-6 space-y-2 text-justify">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Top Universities in Spain for International Students</h2>
      <ul className="list-disc ml-6 space-y-2 text-justify">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Study in Spain with <span className="text-orange-500">VJC Overseas</span></h2>
      <p className="text-justify mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Why Choose <span className="text-orange-500">VJC Overseas</span>?</h2>
      <ul className="list-disc ml-6 space-y-2 text-justify">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Start Your Journey Today!</h2>
