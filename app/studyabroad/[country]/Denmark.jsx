...
const Denmark = () => {
  ...
  <h1 className="text-3xl font-bold mb-4">Denmark Student Visa Guide for <span className="text-orange-500">VJC Overseas</span></h1>
  <p>
  ...
  <h2 className="text-2xl font-semibold mt-6">Why Study in Denmark?</h2>
  <p>
  ...
  <h2 className="text-2xl font-semibold mt-6">How to Apply for a Denmark Student Visa?</h2>
  <p>
  ...
  <h2 className="text-2xl font-semibold mt-6">College and University Fees in Denmark</h2>
  <p>
  ...
  <h3 className="text-xl font-semibold mt-4">Tuition Fees:</h3>
  <ul className="list-disc ml-6 space-y-2">
  ...
  <h2 className="text-2xl font-semibold mt-6">Denmark Student Visa Processing Time</h2>
  <p>
  ...
  <h2 className="text-2xl font-semibold mt-6">Visa Fees</h2>
  <p>
  ...
  <h2 className="text-2xl font-semibold mt-6">Why Choose <span className="text-orange-500">VJC Overseas</span> for Your Denmark Student Visa?</h2>
  <ul className="list-disc ml-6 space-y-2">
  ...
  <h2 className="text-2xl font-semibold mt-6">Contact Us Today</h2>
  <p>
