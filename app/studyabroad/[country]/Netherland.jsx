  ...
  return (
    <div className="max-w-4xl mx-auto px-3 py-8 text-justify text-lg leading-relaxed" style={{ fontFamily: 'Times New Roman, serif' }}>
      <h1 className="text-3xl font-bold mb-6">
        Study in the Netherlands with <span className="text-orange-500">VJC Overseas</span>: Your Gateway to a Bright Future
      </h1>
      ...
      <h2 className="text-2xl font-semibold mb-2">Why Choose the Netherlands for Higher Education?</h2>
      <ul className="list-disc ml-6 space-y-2 text-justify mb-6">
      ...
      <h2 className="text-2xl font-semibold mb-2">Top Universities and Colleges in the Netherlands</h2>
      ...
      <h2 className="text-2xl font-semibold mb-2">Tuition Fees in the Netherlands</h2>
      <ul className="list-disc ml-6 space-y-2 text-justify mb-6">
      ...
      <h2 className="text-2xl font-semibold mb-2">Living Costs and Accommodation in the Netherlands</h2>
      <ul className="list-disc ml-6 space-y-2 text-justify mb-6">
      ...
      <h2 className="text-2xl font-semibold mb-2">Work Opportunities While Studying</h2>
      <p className="text-justify mb-2">
        The Netherlands offers excellent work opportunities for international students:
      </p>
      <ul className="list-disc ml-6 space-y-2 text-justify mb-4">
      ...
      <h2 className="text-2xl font-semibold mb-2">Benefits of Studying in the Netherlands</h2>
      <ul className="list-disc ml-6 space-y-2 text-justify mb-6">
