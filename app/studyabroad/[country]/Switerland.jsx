...
const StudyInSwitzerland = () => {
  return (
    <div className="max-w-4xl mx-auto px-3 py-8" style={{ fontFamily: 'Times New Roman, serif' }}>
      ...
      <h2 className="text-2xl font-semibold mt-6">Why Study in Switzerland?</h2>
      ...
      <h2 className="text-2xl font-semibold mt-6">Tuition Fees at Swiss Universities</h2>
      <ul className="list-disc ml-6 space-y-2 text-justify">
      ...
      <h2 className="text-2xl font-semibold mt-6">Benefits of Studying in Switzerland</h2>
      <ul className="list-disc ml-6 space-y-2 text-justify">
      ...
      <h2 className="text-2xl font-semibold mt-6">Conclusion: Take the First Step Towards Your Swiss Education</h2>
      <p className="text-justify">
