...
const StudyInSouthAfrica = () => {
  return (
    <div className="max-w-4xl mx-auto px-3 py-8 text-justify text-lg leading-relaxed" style={{ fontFamily: 'Times New Roman, serif' }}>
      ...
      <h2 className="text-2xl font-semibold mt-6">Benefits of Choosing <span className="text-orange-500">VJC Overseas</span></h2>
      <ul className="list-disc ml-6 space-y-2 mt-2">
      ...
      <h2 className="text-2xl font-semibold mt-6">Start Your Study Abroad Journey with <span className="text-orange-500">VJC Overseas</span></h2>
      <p>
