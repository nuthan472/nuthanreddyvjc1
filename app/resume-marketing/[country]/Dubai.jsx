...
export default function DubaiResumeMarketing() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 -mt-10 font-[Times_New_Roman]">
      ...
      <p>
        At <span className="text-orange-500">VJC Overseas</span>, we specialize in high-quality resume marketing that not only helps you craft a standout resume but also positions you for success in Dubai’s diverse job landscape.
      </p>
      ...
      <p>
        <span className="text-orange-500">VJC Overseas</span> is dedicated to ensuring that you present your best self to potential employers in Dubai. With our expertise in Dubai resume marketing, we enhance your chances of securing high-paying roles while navigating the complexities of Dubai's job market with confidence.
      </p>
      <ul className="list-disc list-inside space-y-2">
        <li>Tailored resume writing services to align with Dubai's market demands</li>
        <li>Expert career advice to guide you through the job search process</li>
        <li>LinkedIn profile optimization to increase visibility</li>
        <li>Interview preparation to ensure you succeed in securing your dream job</li>
      </ul>

      <h2 className="text-xl md-2 mt-4 font-semibold text-blue-400">Ready to Take the Next Step?</h2>
      <p>
        Unlock your career potential in Dubai with <span className="text-orange-500">VJC Overseas'</span> Dubai resume marketing services. Let us help you land the job you deserve. Contact us today for a free consultation and take the first step toward a successful career in Dubai!
      </p>
