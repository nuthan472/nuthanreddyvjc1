  ...
  return (
    <div className="p-6 max-w-4xl mx-auto text-black text-lg" style={{ fontFamily: 'Times New Roman, serif' }}>
      <div className="flex flex-col md:flex-row items-center md:justify-between mb-6">
        <h1 className="text-2xl font-bold md:w-1/2">
      ...
      <h2 className="text-2xl font-bold mt-6">Why Choose <span className="text-orange-500">VJC Overseas</span> for Air Ticketing?</h2>
      ...
      <h2 className="text-2xl font-bold mt-6">Our Air Ticketing Services Include:</h2>
      ...
      <h2 className="text-2xl font-bold mt-6">Easy Online Booking Process</h2>
      ...
      <h2 className="text-2xl font-bold mt-6">Stay Updated with Latest Travel Deals</h2>
      <p className="text-xl mb-4">Subscribe to our newsletter and follow us on social media for updates on discounted flights...</p>
      
      <h2 className="text-2xl font-bold mt-6">Travel Made Simple with <span className="text-orange-500">VJC Overseas</span></h2>
